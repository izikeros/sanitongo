...
class TestSanitizerPerformance:
    ...
    def test_benchmark_simple_query_sanitization(self, benchmark, sanitizer):
    ...
    def test_benchmark_complex_query_sanitization(self, benchmark, sanitizer):
    ...
    def test_benchmark_query_with_removals_lenient(self, benchmark, lenient_sanitizer):
    ...
    def test_benchmark_array_processing(self, benchmark, sanitizer):
    ...
    def test_benchmark_nested_object_processing(self, benchmark, sanitizer):
    ...
    def test_benchmark_large_query_processing(self, benchmark):
        """Benchmark sanitization of large queries."""
        # Create a sanitizer with higher limits for large queries
        sanitizer = create_sanitizer(strict_mode=True, max_keys=500)
    ...
    def test_benchmark_schema_validation_performance(self, benchmark):
    ...
    def test_benchmark_query_size_scaling(self, benchmark, query_size):
        """Benchmark how performance scales with query size."""
        # Create a sanitizer with higher limits for scaling tests
        sanitizer = create_sanitizer(strict_mode=True, max_keys=200)
    ...
    def test_benchmark_pattern_validation_performance(self, benchmark):
    ...
    def test_benchmark_type_validation_performance(self, benchmark, sanitizer):
...
class TestSanitizerMemoryUsage:
    ...
    def test_benchmark_memory_usage_large_query(self, benchmark):
        """Benchmark memory usage with large queries."""
        sanitizer = create_sanitizer(strict_mode=False, max_keys=2000)
...
class TestPerformanceRegression:
    ...
    def test_benchmark_baseline_performance(self, benchmark):
    ...
    def test_benchmark_worst_case_performance(self, benchmark):
        """Test performance in worst-case scenarios."""
        sanitizer = create_sanitizer(strict_mode=True, max_depth=10)
